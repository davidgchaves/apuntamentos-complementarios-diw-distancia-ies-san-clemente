...
![Resumo de tipos de fontes](./img/fonts.png)
...
![Exemplo de bo uso dunha parella de fontes](./img/bo-uso-dunha-parella-de-fontes.png)
...
![Diferentes exemplo de cor tipográfica](./img/cor-tipografica.png)
